      ...
      await supabase.from("algorithm_results").upsert(
        {
          ...
          momentum_score: momentum?.momentum_score ?? null,
          learning_velocity: momentum?.learning_velocity ?? null,
          scope_trajectory: momentum?.scope_trajectory ?? null,
          motivation_alignment: momentum?.motivation_alignment ?? null,
